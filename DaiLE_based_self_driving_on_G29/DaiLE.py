...
class DaiLE():
    ...
    def __init__(self, model_path, controller=None, fps_target=30, window='Assetto Corsa', debug_mode=True, lightweight_mode=False):
    ...
    def run_action_loop(self):
        ...
        speed, steering_angle, ontrack = telemetry_data.get(
            'speed')/600, telemetry_data.get('steerAngle'), telemetry_data.get('numberOfTyresOut')
        tel = torch.Tensor([speed, steering_angle, ontrack]).unsqueeze(0).cuda()
        ...
        return model_inputs, screenshot, [speed, steering_angle, ontrack]
...
if __name__ == '__main__':
    ...
    # Load in a model
    MODEL_NAME = 'trained_model_1665664945.9503675.obj'
