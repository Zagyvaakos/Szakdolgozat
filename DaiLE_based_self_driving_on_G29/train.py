...
full_path ='C:\\self-driving-wheel'
data_directories = [entry.path for entry in os.scandir('data') if entry.is_dir()]
...
if __name__ == '__main__':
    if False:
        try:
            MODEL = torch.load('models\\trained_model_1665641100.6377995.obj')
